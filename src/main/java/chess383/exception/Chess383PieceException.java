...
public class Chess383PieceException extends Chess383Exception {
     ...
     */
	private static final long serialVersionUID = 7620336112922374119L;
    ...
    public static void throwPieceException( String message ) throws Chess383Exception {
        throw new Chess383PieceException( String.format( "piece exception:", message ) );
    }
}
